...
export async function createDocxDocument(report: CareerReport): Promise<Document> {
  ...
  const doc = new Document({
    ...
    description: `Automated Career Intelligence Report for ${report.candidateInfo.name} generated by SkillBridge AI.`,
    sections: [
      {
        properties: {
          page: {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'Academia × Industry Intelligence Platform • Career & Skills Intelligence',
                bold: true,
                size: 20, // 10pt
                color: COLOR_ACCENT,
                font: 'Arial',
                    ...
                    children: [
                      ...
                      new Paragraph({
                        ...
                        children: [
                          ...
                          new TextRun({
                            text: (report.strengths && report.strengths[0]) || `${(report.skills || []).length} technical competencies extracted with project evidence.`,
                            size: 21,
                            color: COLOR_TEXT,
                            font: 'Arial',
                          }),
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'SkillBridge AI • Connecting Skills, Academia and Industry • Enterprise Career Intelligence Platform',
                size: 17,
                color: COLOR_MUTED,
                italics: true,
                font: 'Arial',
  ...
  return JSON.stringify(
    {
      ...
      tagline: 'Connecting Skills, Academia and Industry',
